...
- (void)baseMapping:(FEMManagedObjectMapping *)mapping
{
    ...
    [mapping addAttribute:[FEMAttribute mappingOfProperty:@"created_at" toKeyPath:@"created_on" dateFormat:@"yyyy-MM-dd'T'HH:mm:ss'Z'"]];
    [mapping addAttribute:[FEMAttribute mappingOfProperty:@"updated_at" toKeyPath:@"updated_on" dateFormat:@"yyyy-MM-dd'T'HH:mm:ss'Z'"]];
...
- (void)baseVenueMapping:(FEMManagedObjectMapping *)mapping
{
    ...
    [mapping addAttributesFromArray:@[@"name", @"house_number_street_name", @"area", @"town", @"post_code", @"web_address", @"phone_number", @"latitude", @"longitude", @"price_bracket", @"menu_url", @"state", @"trip_advisor_link",@"email_adddress"]];
...
- (FEMManagedObjectMapping *)newsMapping
{
    ...
    return [FEMManagedObjectMapping mappingForEntityName:@"DMNewsItem" configuration:^(FEMManagedObjectMapping *mapping) {
        ...
        [mapping addAttributesFromArray:@[@"update_type"]];
...
- (FEMManagedObjectMapping *)offerMapping
{
    ...
    return [FEMManagedObjectMapping mappingForEntityName:@"DMOfferItem" configuration:^(FEMManagedObjectMapping *mapping) {
        ...
        [mapping addAttributesFromArray:@[@"update_type", @"points_required", @"is_special_offer", @"discount", @"terms_conditions", @"is_birthday_offer"]];
...
- (FEMManagedObjectMapping *)completeUserMapping
{
    ...
    return [FEMManagedObjectMapping mappingForEntityName:@"DMUser" configuration:^(FEMManagedObjectMapping *mapping) {
        ...
        [mapping addAttributesFromArray:@[@"first_name", @"last_name", @"facebook_id", @"email_address", @"gender", @"device_scale", @"profile_picture", @"post_code", @"annual_points_earned", @"annual_points_balance", @"notification_frequency", @"notification_filter", @"referred_points", @"is_email_verified"]];
